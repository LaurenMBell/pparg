...
def get_model_artifacts(force_retrain: bool = False):
    """
    Returns cached artifacts (model + evaluation) for the antagonist classifier.
    """
    ...
    # Empirical null for hit scores + simple null classifier baseline.
...
def predict(smiles: str):
    """
    Predict antagonist activity for a SMILES string.
